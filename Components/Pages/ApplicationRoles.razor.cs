...
namespace DESKTOPJN6V6MTSQLEXPRESS.Components.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<DESKTOPJN6V6MTSQLEXPRESS.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(DESKTOPJN6V6MTSQLEXPRESS.Models.ApplicationRole role)
        {
            try
            {
