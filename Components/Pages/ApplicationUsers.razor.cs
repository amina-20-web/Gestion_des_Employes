...
namespace DESKTOPJN6V6MTSQLEXPRESS.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<DESKTOPJN6V6MTSQLEXPRESS.Models.ApplicationUser> users;
        protected RadzenDataGrid<DESKTOPJN6V6MTSQLEXPRESS.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(DESKTOPJN6V6MTSQLEXPRESS.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(DESKTOPJN6V6MTSQLEXPRESS.Models.ApplicationUser user)
        {
            try
            {
